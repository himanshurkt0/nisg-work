...
public interface AppService {
	...
	public String getLVRSerialNumber(String empCode, String dependentconstant);
	...
	public List<Object[]> getFinAssistDataToEdit(String empCode,String srNo, String appConstant);

	public Blob getFinAssisPdf(String empCode, String srNo, String dependentconstant);
	...
	public String getNPClaimDate(String empCode, String string);
	...
	boolean saveNpBriefCaseClaim(ReimbursementBean reimbursementBean);
	
	boolean saveNpBookGrantClaim(ReimbursementBean reimbursementBean);
	...
	public String getLapMobileLnDate(ReimbursementBean reimbursementBean, String string);
	...
	public int getLaptopReimCheck(String empCode, String laptopValidMonths);
